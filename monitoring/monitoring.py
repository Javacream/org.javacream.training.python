...
class Metric:
    ...
    def __repr__(self) -> str:
        return f"Metric: type={self.type}, name={self.name}, value={self.value}, timestamp={self.timestamp}"
...
def test():
    ...
    metric1 = Metric("Gauge", 'CPU Utilization', 0.78)
    metric2 = Metric("Counter", 'Http Request Counter', 4)
    metric3 = Metric("Gauge", 'Storage', '123.45B')
