...
import unittest2
from javacream.booksservice import BookException, BooksService
...
class BooksServiceTest(TestCase):
    ...
    def setUp(self):
        ...
        testutils.decorate(self.isbngenerator, testutils.trace)
        testutils.decorate(self.booksservice, testutils.trace)
