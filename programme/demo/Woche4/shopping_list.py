def read_raw_shopping_list(path = './programme/demo/Woche4/raw_shopping_list.txt'):
...
def write_shopping_list(shopping_list, path = './programme/demo/Woche4/shopping_list.txt'):
